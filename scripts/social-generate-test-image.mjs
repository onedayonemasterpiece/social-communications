...
const outputPath = path.resolve(
  process.argv[2]
  || process.env.SOCIAL_TEST_IMAGE_PATH
  || 'generated/social-test-post.png',
);
const width = 640;
const height = 360;
...
console.log(`SOCIAL_TEST_IMAGE_CREATED=${outputPath} bytes=${png.length} dimensions=${width}x${height}`);
